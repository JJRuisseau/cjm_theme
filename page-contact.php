...
<section class="flex justify-center">
    <div class="container py-4 flex-col flex items-center">
        ...
        <p class="max-w-xl text-center mt-6">
            <?php echo the_field('contact_bloc'); ?> 
        </p>
        <ul class="flex justify-center gap-2 mt-5">
            <li class="transform hover:scale-125 delay-150 duration-700 ease-in-out ">
                <a href="https://www.facebook.com/cerlejeanmermoz" target="_blank">
                    <svg class="h-8 w-8 svg-icon-contact" viewBox="0 0 20 20">
                        <path fill="none" d="M11.344,5.71c0-0.73,0.074-1.122,1.199-1.122h1.502V1.871h-2.404c-2.886,0-3.903,1.36-3.903,3.646v1.765h-1.8V10h1.8v8.128h3.601V10h2.403l0.32-2.718h-2.724L11.344,5.71z"></path>
                    </svg>
                </a>
            </li>
            <li class="transform hover:scale-125 delay-150 duration-700 ease-in-out ">
                <a href="https://twitter.com/cercle_toulouse" target="_blank">
                    <svg class="svg-icon-contact h-8 w-8" viewBox="0 0 20 20">
            ...
            <li class="transform hover:scale-125 delay-150 duration-700 ease-in-out ">
                <a href="https://www.youtube.com/c/CercleJeanMermoz" target="_blank">
                    <svg class="svg-icon-contact h-8 w-8" viewBox="0 0 20 20">
